...
class Statistic extends Component {
    ...
    render() {
      ...
      let orderPull = orders.getStatisticMap(); // изменил сортировку -> последнии заказы сверху, показую последних 51 заказ
      ...
      return (
        <div className="statistic">
          ...
          <Row className={this.state.showPopup ? "hide" : ""}>
            ...
            <Col xs={7} >
              <h1 className="main-title">{activeMenu.title}</h1>
              <div>
                <span>Период</span>
              ...
              <Chart data={orderPull} type='doughnut'/>
            </Col>
            <Col xs={3} >
              {" "}
            </Col>
